...
;(function (root, factory) {
    ...
    if (typeof define === "function" && define.amd)
        ...
        root.Sign = factory(root.$, root._, root.Backbone);
    ...
    function jSignatureClass(parent, options, instanceExtensions) {
        ...
        , settings = {
            ...
            , 'color': '#000', 'background-color': '#fff', 'decor-color': '#eee', 'lineWidth': 0, 'minFatFingerCompensation': -10, 'showUndoButton': false, 'data': []
        }
