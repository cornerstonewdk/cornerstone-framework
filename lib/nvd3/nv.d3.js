  ...
  function chart(selection) {
     ...
     */
      ...
      function onBrush() {
        ...
        if (Math.abs(extent[0] - extent[1]) < 0) {
          return;
        }
                ...
                .map(function(d,i) {
                  return {
                    ...
                    values: d.values.filter(function(d,i) {
                      return lines.x()(d,i) >= Math.floor(extent[0]) && lines.x()(d,i) <= Math.ceil(extent[1]);
                    })
                  }
                })
            );
...
nv.models.multiBar = function() {
  ...
  var margin = {top: 0, right: 0, bottom: 0, left: 0}
    ...
    , yRange
    , groupSpacing = 0.1
    , dispatch = d3.dispatch('lastAnimated', 'animated', 'chartClick', 'elementClick', 'elementDblClick', 'elementMouseover', 'elementMouseout')
    , transitionDuration = 250
    ;
  ...
  function chart(selection) {
    selection.each(function(data) {
      ...
      if (barColor) {
        ...
        var animatedDispatch = function(target, d, i) {
            dispatch.animated({
                index: i,
                data: d,
                series: data[d.series],
  ...
  function chart(selection) {
    selection.each(function(data) {
      ...
      var ae = slices.enter().append('g')
        ...
        var lastPath = d3.merge(paths).reverse()[0];
        var animatedDispatch = function(target, d, i) {
            dispatch.animated({
                index: i,
                data: d,
...
nv.models.scatter = function() {
  ...
  var margin       = {top: 0, right: 0, bottom: 0, left: 0}
    ...
    , sizeRange    = null
    , singlePoint  = false
    , dispatch     = d3.dispatch('lastAnimated', 'animated', 'elementClick', 'elementMouseover', 'elementMouseout')
    , useVoronoi   = true
    , transitionDuration = 250
    ;
  ...
  function chart(selection) {
    selection.each(function(data) {
      ...
      groups
        ...
        var animatedDispatch = function(target, lastTarget, d, i) {
            dispatch.animated({
                index: i,
                data: d,
                series: data[d.series],
      ...
      if (onlyCircles) {
        ...
        var lastPath = d3.merge(points).reverse()[0];
        ...
        points.transition()
            ...
            .attr('r', function(d,i) { return Math.sqrt(z(getSize(d,i))/Math.PI) })
            .each('end', function(d, i) {
                animatedDispatch(this, lastPath, d, i);
            });
