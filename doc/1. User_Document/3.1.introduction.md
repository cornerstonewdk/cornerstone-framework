...
<ul>
	<li><i class="icon-up">icon-up</li>
	<li><i class="icon-down">icon-down</li>
	<li><i class="icon-set">icon-set</li>
</ul>

#### Cornerstone의 navbar icon class ####

<ul>
	<li><i class="icon-home">icon-home</li>
	<li><i class="icon-list">icon-list</li>
	<li><i class="icon-message">icon-message</li>
	<li><i class="icon-mail">icon-mail</li>
	<li><i class="icon-save">icon-save</li>
	<li><i class="icon-user2">icon-user2</li>
	<li><i class="icon-connect">icon-connect</li>
	<li><i class="icon-search">icon-search</li>
	<li><i class="icon-write">icon-write</li>
	<li><i class="icon-about">icon-about</li>
	<li><i class="icon-favorites">icon-favorites</li>
	<li><i class="icon-downloads">icon-downloads</li>
	<li><i class="icon-settings">icon-settings</li>
	<li><i class="icon-user">icon-user</li>
</ul>
