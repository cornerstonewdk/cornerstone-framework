...
## Example
### DATA-API
<iframe class="jsbin-livecode" src="http://jsbin.com/iCeloYA/5/embed?html,output"></iframe>

### jQuery Plugin
<iframe class="jsbin-livecode" src="http://jsbin.com/oyABUpU/2/embed?html,js,output"></iframe>

### Backbone View
<iframe class="jsbin-livecode" src="http://jsbin.com/iZacAY/2/embed?html,js,output"></iframe>