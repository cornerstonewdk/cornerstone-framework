...
DATA-API(data-attribute), $('#example').featuredDataTable() 또는 MVC의 View객체로써 사용할 수 있다.

#### DATA-API(data-attribute) 를 이용하는 방식

``` cm,{ iframe-height : 700px }
<div class="container">
	<h3>Data Table DATA-API</h3>
