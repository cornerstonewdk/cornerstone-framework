...
## Example
### DATA-API
<iframe class="jsbin-livecode" src="http://jsbin.com/EFOyaLA/4/embed?html,output"></iframe>

### jQuery Plugin
<iframe class="jsbin-livecode" src="http://jsbin.com/IlaREN/2/embed?html,js,output"></iframe>

### Backbone View
<iframe class="jsbin-livecode" src="http://jsbin.com/oyEXiyU/2/embed?html,js,output"></iframe>
