  ...
  <div class="row-fluid">
    <div class="span4">
      ...
      <div class="dash-widget no-padding widget-rangeinput">
        <label>
          <input type="range" data-plugin="rangeinput" value="0.5" min="0.1" max="99.9" step="0.1"
    ...
    <div class="span4">
      ...
      <div class="dash-widget no-padding widget-rangeinput">
        <label>
          <input type="range" data-plugin="rangeinput" value="10" min="0" max="100"
               class="widget-range btn-block"
    ...
    <div class="span4">
      ...
      <div class="dash-widget no-padding widget-rangeinput slider-box">
        <label>
          <input type="range" data-plugin="rangeinput" value="0.5" min="0.1" max="999.9" step="10"
