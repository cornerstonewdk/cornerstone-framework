...
## Example
### DATA-API
<iframe class="jsbin-livecode" src="http://jsbin.com/alEZefE/6/embed?html,output"></iframe>

### jQuery Plugin
<iframe class="jsbin-livecode" src="http://jsbin.com/AHIFUbO/3/embed?html,js,output"></iframe>

### Backbone View
<iframe class="jsbin-livecode" src="http://jsbin.com/utomuri/4/embed?html,js,output"></iframe>