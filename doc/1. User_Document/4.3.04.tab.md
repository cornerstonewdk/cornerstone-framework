...
## Example
### DATA-API
<iframe class="jsbin-livecode" src="http://jsbin.com/uNEhifE/5/embed?html,output"></iframe>

### jQuery Plugin
<iframe class="jsbin-livecode" src="http://jsbin.com/iXinUr/7/embed?html,js,output"></iframe>

### Backbone View
<iframe class="jsbin-livecode" src="http://jsbin.com/uWUduju/2/embed?html,js,output"></iframe>