...
문서내 인용한 부분에 적용된다. 인용한 글의 작성자 이름등에는 `<small>`, `<cite>`를 사용하여 적용한다.
오른쪽 정렬을 할때는 `.pull-right`를 사용한다.
...
## Lists ##
기본 제공되는 Lists 형식보다 시각적으로 강조하여 표현하고 싶다면 이 Lists 요소를 사용하기 비란다.
...
## Nav bar. mobile ##
mobile에서만 사용하는 Navigation 요소로써 사용자에게 가시적인 편의성을 제공할때 사용한다.
