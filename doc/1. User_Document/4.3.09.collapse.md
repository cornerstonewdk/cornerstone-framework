...
## Example
### DATA-API
<iframe class="jsbin-livecode" src="http://jsbin.com/iMIHADE/5/embed?html,output"></iframe>

### jQuery Plugin
<iframe class="jsbin-livecode" src="http://jsbin.com/UhiwOm/7/embed?html,js,output"></iframe>
