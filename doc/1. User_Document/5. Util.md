...
device( SRT-1.0 ) | 웹으로는 구현 불가능한 단말기의 Native 기능들을 제공하는 런타임 유틸리티
...
```
require( [ 'transition', 'jsonp', 'skt', 'srt-1.0' ], function( Transition, Jsonp, SKT ) {
...
-	일반 방식
		...
		<script type="text/javascript" src="SRT-1.0.js"></script>

-	MVC Framework을 이용한 의존성 주입
		
		define( [ 'srt-1.0' ], function () {
				(중략...)
		} );
