...
## Example
### DATA-API
<iframe class="jsbin-livecode" src="http://jsbin.com/iVoWitu/2/embed?html,output"></iframe>

### jQuery Plugin
<iframe class="jsbin-livecode" src="http://jsbin.com/IyAPEMiz/2/embed?html,js,output"></iframe>

### Backbone View
<iframe class="jsbin-livecode" src="http://jsbin.com/OmasaBi/2/embed?html,js,output"></iframe>
