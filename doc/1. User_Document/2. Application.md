...
이벤트가 발생하면 자세한 정보를 담고 있는 event 객체가 callback의 인자로 전달된다. event 객체가 담고 있는 정보는 이벤트의 종류에 따라 다르다.
...
![](http://prandy.iptime.org:3000/html5_framework/doc/blob?path=doc%2F1.+User_Document%2Fimages%2Fvalidation1.png)

만약에 input 다음에 있는 `<span class="help-inline"></span>`을 제거한다면 tooltip이 자동적으로 추가되어 다음과 같이 보일 것이다.

![](http://prandy.iptime.org:3000/html5_framework/doc/blob?path=doc%2F1.+User_Document%2Fimages%2Fvalidation2.png)
...
![](http://prandy.iptime.org:3000/html5_framework/doc/blob?path=doc%2F1.+User_Document%2Fimages%2Fvalidation3.png)
