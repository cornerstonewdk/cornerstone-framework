...
| ------- | ------------------------ | ------------------------- |
| Content | Content Cell12321312331  | Content1231232132323 Cell |
| Content | Content Cell12312312321  | Content1231232131232 Cell |
...
BTS hover(O)	BTS hover(X)	FastButton	평균 소요시간	체감 의견
그림. 5-1	O	X	X	0.2 ~ 0.3초	Hover 후에 click 발생으로 상당히 느리다고 느켜짐.
그림. 5-2	X	O	X	0.05 ~ 0.1초	반응 속도가 그림5.1에 비해 상당히 빨라짐.
그림. 5-3	O	X	O	0.03 ~ 0.5초	그림 5.2와 체감상 차이는 크지 않다.
그림. 5-4	X	O	O	0.03 ~ 0.5초	그림 5.3와 체감상 차이는 크지 않다.
