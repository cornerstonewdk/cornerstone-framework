...
rm -rf /home/appadmin/CORNER/git/CornersGithub/cornerstone-framework.example/examples/cornerstone.docpad/src/documents/*.eco
cp *.eco /home/appadmin/CORNER/git/CornersGithub/cornerstone-framework.example/examples/cornerstone.docpad/src/documents/

LIVEDOC_IMG=/home/appadmin/CORNER/git/CornersGithub/cornerstone-framework.example/examples/cornerstone.docpad/src/files/images
cp "/home/appadmin/CORNER/git/CornersGithub/cornerstone-framework.doc/doc/1. User_Document/images"/* $LIVEDOC_IMG/
cp "/home/appadmin/CORNER/git/CornersGithub/cornerstone-framework.doc/doc/2. Reference/images"/* $LIVEDOC_IMG/
cp "/home/appadmin/CORNER/git/CornersGithub/cornerstone-framework.doc/doc/3. Runtime/images"/* $LIVEDOC_IMG/
