// QRCODE 추가
var pageUrl = "http://www.jnwlab.com/site/workspace/cornerstone/cornerstone-mywork/widget/demo/plugin.html";
...
// Flip Switch
$(".handle, input[type=range]:first-child").bind("drag", function (e, vertical, horizontal) {
    console.log(e, vertical, horizontal);
});

// Carousel Event Test
$(".carousel").swipe().bind("swipeLeft",function (e) {
    console.log("left");
