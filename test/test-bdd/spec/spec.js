describe('Cornerstone 이벤트 확장, view 모듈화 통합 test', function() {
    ...
    //                     e.stopPropagation();
    //                     Logging.info('horizontalBarChart complete', e);
    //                     done();
    //                 });
    ...
    //                 }).on('complete.cs.chart', function(e) {
    //                     e.stopPropagation();
    //                     Logging.info('linePlusBarChart complete', e);
    //                     done();
    //                 });
    ...
    //                 }).on('complete.cs.chart', function(e) {
    //                     e.stopPropagation();
    //                     Logging.info('lineChart complete', e);
    //                     done();
    //                 });
    ...
    //                 }).on('complete.cs.chart', function(e) {
    //                     e.stopPropagation();
    //                     Logging.info('pieChart complete', e);
    //                     done();
    //                 });
    ...
    //                 }).on('complete.cs.chart', function(e) {
    //                     e.stopPropagation();
    //                     Logging.info('bar3dChart complete', e);
    //                     done();
    //                 });
    ...
    //                 }).on('complete.cs.chart', function(e) {
    //                     e.stopPropagation();
    //                     Logging.info('horizontal3dBarChart complete', e);
    //                     done();
    //                 });
    ...
    //         it('lineFocusChart가 보여질 때 shown, complete 이벤트가 발생하여야 한다.', function() {
    //             require(['widget-chart'], function(WidgetChart) {
    //                 var Model = Backbone.Model.extend({
    //                     url: 'data/sample-line.json'
    //                 });
    ...
    //                 }).on('complete.cs.char', function(e) {
    //                     e.stopPropagation();
    //                     Logging.info('lineFocusChart complete', e);
    //                     done();
    //                 });
