    ...
    if(jsonS){
        $.each(jsonS, function( index , entry ) {
            ...
            $.each(entry,function(key,val){
                is_data=true;
                if(key=="val_id")  val_id=val;
                if(key=="val_txt") val_txt=val;
                if(key=="val_etc") val_etc=val;
            });
            if(is_data){
...
{    
    ...
    if(Obj.FunctionType == 'getRptModelColor')
    {
