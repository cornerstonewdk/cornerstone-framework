...
requirejs.config( {
    ...
    paths: {
        ...
        ,'cf_common'            :'commonJs/cf_common'
        ,'cf_auth'              :'commonJs/cf_auth'
        ,'cf_map'               :'commonJs/cf_map'
        ,'cf_alertmsg'          :'commonJs/cf_alertmsg'
        ,'cf_date'              :'commonJs/cf_date'
        ,'cf_tkey_common'       :'commonJs/cf_tkey_common'
        ,'cf_AES'               :'commonJs/cf_AES'
        ,'cf_datepicker'        :'commonJs/cf_datepicker'
        ,'cf_new_validation'    :'commonJs/cf_validation'
		,'cf_validation'        :'commonJs/cf_inputValidation'
        ,'cf_regularExpression' :'commonJs/cf_regularExpression'
        ,'cf_ajax'              :'commonJs/cf_ajax'
        ,'cf_makeMenu'          :'commonJs/cf_makeMenu'
        ,'cf_makeGrid'          :'commonJs/cf_makeGrid'
        ,'cf_loadPage'          :'commonJs/cf_loadPage'
        ,'storage'              :'commonJs/storage'
        ,'cf_commonUiData'      :'commonJs/cf_commonUiData'
        ,'regModel'             :'commonJs/regModel'
        ,'regView'              :'commonJs/regView'
        ,'cf_hardwaresearch'    :'commonJs/hardware_search'
        ,'cf_transScreen'       :'commonJs/cf_transScreen'
        ,'cf_quick_search'      :'quicksearch/js/cf_quick_search'
        ,'cf_TCinput'           :'commonJs/cf_TCinput'
        ,'cf_formAPI'           :'commonJs/cf_formAPI'
        ,'cf_confirmModal'      :'commonJs/cf_confirmModal'
        ,'mTkeyCommon'          :'commonJs/mTkeyCommon'
    },
