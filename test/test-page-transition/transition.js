...
;(function ($, window, document) {
    ...
    Plugin.prototype = {
        ...
        // 화면전환 시작하기 전 실행(변수 유효성 검사 및 사용자가 정의한 before 실행)
        ...
        // 화면전환 완료시 실행
        _done:function (opt) {
            console.log(opt.inTarget.id, opt.outTarget.id, opt.transitionType);

            this.beforeTransitionType = opt.transitionType;
    ...
    Effect.prototype = {
        ...
        flip:function (opt) {
            ...
            console.log(this.inTargetCss, this.outTargetCss);
            ...
            console.log(this.inTargetCss, this.outTargetCss, $(opt.inTarget.id).attr("style"), $(opt.outTarget.id).attr("style"));
        },
